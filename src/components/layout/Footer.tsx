...
export function Footer() {
  return (
    <footer className="bg-canvas-dark text-white pt-16 pb-24 lg:pb-16 border-t border-neutral-800">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-14 border-b border-neutral-800/80">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-2 font-display text-2xl font-black tracking-tighter">
                <span>ÖZÜ</span>
                <span className="text-volt">RUNNING CLUB</span>
              </div>
            ...
            <div className="mt-8 flex items-center gap-3">
              <span className="text-xs font-mono uppercase tracking-telemetry text-volt">
                Çekmeköy Campus
              </span>
              <span className="text-neutral-600">•</span>
              <span className="text-xs font-mono uppercase tracking-telemetry text-neutral-400">
                Istanbul, TR
              </span>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link href="/join" className="text-volt hover:underline flex items-center gap-1 font-semibold">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-between p-3 bg-neutral-900 rounded-lg hover:bg-neutral-800 transition-colors border border-neutral-800"
              >
              ...
              <div className="p-3 bg-neutral-900/60 rounded-lg border border-neutral-800/60 text-xs text-neutral-400 flex items-start gap-2">
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-neutral-500 font-mono">
          ...
          <div className="flex items-center gap-1 text-neutral-400">
            ...
            <Heart className="w-3.5 h-3.5 text-volt fill-volt" />
